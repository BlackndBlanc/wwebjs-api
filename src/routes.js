...
// API basic callback (if enabled in config)
...
sessionRouter.get(
  '/getPageScreenshot/:sessionId',
  middleware.sessionNameValidation,
  sessionController.getPageScreenshot
)
...
clientRouter.delete(
  ...
  [middleware.sessionNameValidation, middleware.sessionValidation],
  clientController.deleteProfilePicture
)
clientRouter.post(
  '/setAutoDownloadAudio/:sessionId',
  [middleware.sessionNameValidation, middleware.sessionValidation],
  clientController.setAutoDownloadAudio
)
clientRouter.post(
  '/setAutoDownloadDocuments/:sessionId',
  [middleware.sessionNameValidation, middleware.sessionValidation],
  clientController.setAutoDownloadDocuments
)
clientRouter.post(
  '/setAutoDownloadPhotos/:sessionId',
  [middleware.sessionNameValidation, middleware.sessionValidation],
  clientController.setAutoDownloadPhotos
)
clientRouter.post(
  '/setAutoDownloadVideos/:sessionId',
  [middleware.sessionNameValidation, middleware.sessionValidation],
  clientController.setAutoDownloadVideos
)
clientRouter.post(
  '/syncHistory/:sessionId',
  [middleware.sessionNameValidation, middleware.sessionValidation],
  clientController.syncHistory
)
clientRouter.post(
  '/getContactDeviceCount/:sessionId',
  [middleware.sessionNameValidation, middleware.sessionValidation],
  clientController.getContactDeviceCount
)
clientRouter.post(
  '/getCountryCode/:sessionId',
  [middleware.sessionNameValidation, middleware.sessionValidation],
  clientController.getCountryCode
)
clientRouter.post(
  '/getFormattedNumber/:sessionId',
  [middleware.sessionNameValidation, middleware.sessionValidation],
  clientController.getFormattedNumber
)
clientRouter.post(
  '/openChatWindow/:sessionId',
  [middleware.sessionNameValidation, middleware.sessionValidation],
  clientController.openChatWindow
)
clientRouter.post(
  '/openChatWindowAt/:sessionId',
  [middleware.sessionNameValidation, middleware.sessionValidation],
  clientController.openChatWindowAt
)
clientRouter.post(
...
clientRouter.post(
  '/setBackgroundSync/:sessionId',
  [middleware.sessionNameValidation, middleware.sessionValidation],
  clientController.setBackgroundSync
)
...
chatRouter.post(
  '/syncHistory/:sessionId',
  [middleware.sessionNameValidation, middleware.sessionValidation],
  chatController.syncHistory
)
chatRouter.post(
  '/getLabels/:sessionId',
  [middleware.sessionNameValidation, middleware.sessionValidation],
  chatController.getLabels
)
chatRouter.post(
  '/changeLabels/:sessionId',
  [middleware.sessionNameValidation, middleware.sessionValidation],
  chatController.changeLabels
)
...
groupChatRouter.post(
  '/getGroupMembershipRequests/:sessionId',
  [middleware.sessionNameValidation, middleware.sessionValidation],
  groupChatController.getGroupMembershipRequests
)
groupChatRouter.post(
...
messageRouter.post(
  '/downloadMediaAsData/:sessionId',
  [middleware.sessionNameValidation, middleware.sessionValidation],
  messageController.downloadMediaAsData
)
messageRouter.post(
  '/forward/:sessionId',
  [middleware.sessionNameValidation, middleware.sessionValidation],
...
messageRouter.post(
  '/getGroupMentions/:sessionId',
  [middleware.sessionNameValidation, middleware.sessionValidation],
  messageController.getGroupMentions
)
messageRouter.post(
  '/edit/:sessionId',
  [middleware.sessionNameValidation, middleware.sessionValidation],
...
// إعادة تعريف بعض المسارات في الجدول العلوي (من أجل السهولة السابقة)
...
// ──────────────────────────────────────
// إضافة مسار “send-message” في نهاية الملف
